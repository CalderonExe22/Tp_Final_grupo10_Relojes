<?php
    ...
    //$permitirAcceso = '../Cliente/listaCompras.php';
    ...
    $param["idusuario"] = $idUsuarioLogeado;
    $listaCompras = $objItems->buscar($param/*['idusuario' => $sesion->getIDUsuarioLogueado()]*/);
    ...
    if (count($listaCompras) > 0) {
        ...
        <div class="container my-2">
            ...
            <script src="../JS/js/funcionesABMListadoCompras.js"></script>
        </div>
    <?php } else {
        ?>
        <div id="contenedor" class="container py-5 text-center">
            <div class=" card mb-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4"><img src="../img/,essi.jpg" class="img-fluid rounded-start" alt="..."></div>
                    <div class="col-md-8">
                        <div class="card-body">
