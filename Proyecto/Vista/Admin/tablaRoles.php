<?php
$Titulo = "Tabla Roles";
//$permitirAcceso = '../Admin/tablaRoles.php';
...
/*if (!$sesion->verificarPermiso('../Admin/tablaRoles.php')) {
    ...
    $objRoles = new abmRol();
    $listaRoles = convert_array($objRoles->buscar(null));
...
?>
            ...
            <div class="table-responsive">
                <table class="table table-hover caption-top align-middle text-center" id="tablaRoles">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        ?>
                            <tr>
                                <td><?php echo $objR["idrol"] ?></td>
                                <td><?php echo $objR["rodescripcion"] ?></td>
                                <td>
        ...
        <script src="../JS/js/funcionesABMRol.js"> </script>
    <?php } else {
    ?>
